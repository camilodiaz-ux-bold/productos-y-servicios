import svgPaths from "./svg-4d8k78fato";
        ...
        <div className="content-stretch flex gap-[12px] items-center p-[12px] relative size-full">
          ...
          <div className="flex-[1_0_0] min-w-px relative" data-name=".atom/search_bar_styles">
            <div className="content-stretch flex items-start px-[4px] py-[8px] relative size-full">
              <div className="[word-break:break-word] flex flex-col font-['Montserrat:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#606060] text-[14px] whitespace-nowrap">
  ...
  return (
    <div className="content-stretch flex items-center pl-[8px] relative rounded-[100px] shrink-0" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#121e6c] text-[12px] text-center whitespace-nowrap">
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid leading-[16px] underline">Nuevo</p>
      </div>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[16px] top-[104px] w-[343px]">
...
function Number() {
  return (
    <div className="absolute contents left-[12px] top-[12px]" data-name="Number">
      <div className="absolute left-[12px] size-[12px] top-[12px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
          <circle cx="6" cy="6" fill="var(--fill-0, #FF2947)" id="Ellipse 10" r="6" />
        </svg>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] left-[18px] size-[12px] text-[8px] text-center text-white top-[18px]">
...
function NavigationBar() {
  return (
    <div className="content-stretch flex gap-[45px] items-center justify-center relative shrink-0 w-full" data-name="Navigation bar">
      ...
      <div className="bg-white content-stretch flex gap-[4px] items-center relative rounded-[100px] shrink-0 w-[205px]" data-name="APP Tabs / Navigation">
        <div className="bg-white flex-[1_0_0] min-w-px relative rounded-[100px]" data-name=".atoms/superapp_tabs">
      ...
      <div className="relative shrink-0 size-[24px]" data-name="icon/ic_shopping_notification">
        <div className="absolute inset-[4.17%_1.33%_4.42%_4.17%]" data-name="Vector">
          <div className="absolute inset-[-0.46%_-0.57%_-0.46%_-0.44%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.9119 22.14">
              <path d={svgPaths.p3ae88740} fill="var(--fill-0, #121E6C)" id="Vector" stroke="var(--stroke-0, #121E6C)" strokeWidth="0.1" />
            </svg>
          </div>
        </div>
        <Number />
...
function AppHeader() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-center left-0 pb-[16px] top-0 w-[375px]" data-name="APP Header">
            ...
            <div className="relative size-full" data-name="Status">
              <div className="absolute inset-[-2.5%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 84 84.0001">
                  <path d={svgPaths.p22aeab80} id="Status" stroke="url(#paint0_radial_1_916)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
                  <defs>
                    <radialGradient cx="0" cy="0" gradientTransform="matrix(65 -66.4407 7.96225 221.571 11.7222 74.2034)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_916" r="1">
...
function Historial1() {
  return (
    <div className="content-stretch flex flex-col items-start py-[12px] relative shrink-0 w-[375px]" data-name="Historial">
      <Day1 />
    </div>
  );
}
...
function Value() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start leading-[0] min-w-px relative" data-name="Value">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#606060] text-[12px] w-full">
        <p className="leading-[16px]">0 Productos</p>
      </div>
      <div className="flex flex-col font-['Montserrat:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#1e1e1e] text-[16px] w-full">
...
function ButtonPayments() {
  return (
    <div className="bg-[#ffb2bc] flex-[1_0_0] h-[48px] min-w-px relative rounded-[100px]" data-name="Button Payments">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[16px] items-center justify-center px-[25px] py-[24px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#ffdfe4] text-[14px] text-center whitespace-nowrap">
...
function AppButtonPos() {
  return (
    <div className="absolute backdrop-blur-[6px] bg-[rgba(247,248,251,0.2)] bottom-0 content-stretch flex items-center left-0 px-[16px] py-[20px] w-[375px]" data-name="APP Button / POS">
      <Value />
      <div className="content-stretch flex items-center justify-center relative shrink-0 w-[174px]" data-name="APP Button / Default">
        <ButtonPayments />
      </div>
    </div>
  );
...
export default function Ventas() {
  return (
    <div className="bg-[#f7f8fb] relative size-full" data-name="Ventas">
      <Frame />
      <AppHeader />
      <Historial />
      <AppButtonPos />
