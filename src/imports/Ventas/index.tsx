import svgPaths from "./svg-mtsg6ocp1y";
            ...
            <div className="relative size-full" data-name="Status">
              <div className="absolute inset-[47.5%_-2.5%_-2.5%_-2.5%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 84 44">
                  <path d={svgPaths.pd408e40} id="Status" stroke="url(#paint0_radial_1_576)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
                  <defs>
                    <radialGradient cx="0" cy="0" gradientTransform="matrix(65 -66.4407 7.96225 221.571 11.7222 34.2034)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_576" r="1">
