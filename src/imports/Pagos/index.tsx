import svgPaths from "./svg-9t7650crhm";
        ...
        <div className="absolute inset-[4.17%_24.22%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.6875 40.3333">
            <g id="Vector">
              ...
              <path clipRule="evenodd" d={svgPaths.p1bd7a280} fill="url(#paint0_radial_1_2318)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p1bd7a280} fill="url(#paint1_radial_1_2318)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p2eeace00} fill="var(--fill-0, #121E6C)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p2eeace00} fill="url(#paint2_radial_1_2318)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p2eeace00} fill="url(#paint3_radial_1_2318)" fillRule="evenodd" />
            </g>
            <defs>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(-3.78788 -16.8056 17.9865 4.36729 15.6776 40.3333)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_2318" r="1">
                <stop offset="0.147248" stopColor="#FF2947" />
                <stop offset="1" stopColor="#FF2947" stopOpacity="0" />
              </radialGradient>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(9.33237 18.7034 -18.0368 0.984205 4.73485 1.44048)" gradientUnits="userSpaceOnUse" id="paint1_radial_1_2318" r="1">
                <stop offset="0.107248" stopColor="#FF2947" />
                <stop offset="1" stopColor="#FF2947" stopOpacity="0" />
              </radialGradient>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(-3.78788 -16.8056 17.9865 4.36729 15.6776 40.3333)" gradientUnits="userSpaceOnUse" id="paint2_radial_1_2318" r="1">
                <stop offset="0.147248" stopColor="#FF2947" />
                <stop offset="1" stopColor="#FF2947" stopOpacity="0" />
              </radialGradient>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(9.33237 18.7034 -18.0368 0.984205 4.73485 1.44048)" gradientUnits="userSpaceOnUse" id="paint3_radial_1_2318" r="1">
                <stop offset="0.107248" stopColor="#FF2947" />
                <stop offset="1" stopColor="#FF2947" stopOpacity="0" />
              </radialGradient>
            </defs>
      ...
      <div className="relative shrink-0 size-[44px]" data-name="icon_fill/ic_money_bag">
        <div className="absolute inset-[2.08%_12.03%_4.17%_12.03%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33.4167 41.25">
            <g id="Vector">
              <path clipRule="evenodd" d={svgPaths.p24407e00} fill="url(#paint0_radial_1_2292)" fillRule="evenodd" />
              <path d={svgPaths.p1df0bdf0} fill="url(#paint1_radial_1_2292)" />
            </g>
            <defs>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(27.1511 -34.2585 34.3943 61.8568 4.06106 37.2299)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_2292" r="1">
                <stop offset="0.153871" stopColor="#FF2947" />
                <stop offset="0.695363" stopColor="#121E6C" />
              </radialGradient>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(27.1511 -34.2585 34.3943 61.8568 4.06106 37.2299)" gradientUnits="userSpaceOnUse" id="paint1_radial_1_2292" r="1">
                <stop offset="0.153871" stopColor="#FF2947" />
                <stop offset="0.695363" stopColor="#121E6C" />
              </radialGradient>
            </defs>
      ...
      <div className="relative shrink-0 size-[44px]" data-name="icon_fill/ic_sale">
        <div className="absolute inset-[4.17%_14.4%_2.08%_16.67%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30.3303 41.25">
            <path clipRule="evenodd" d={svgPaths.p3426b9a0} fill="url(#paint0_radial_1_2294)" fillRule="evenodd" id="Vector" />
            <defs>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(24.6434 -34.2585 31.2176 61.8568 3.68597 37.2299)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_2294" r="1">
                <stop offset="0.153871" stopColor="#FF2947" />
                <stop offset="0.695363" stopColor="#121E6C" />
              </radialGradient>
            </defs>
